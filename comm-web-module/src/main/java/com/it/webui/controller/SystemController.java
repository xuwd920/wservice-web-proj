...
import com.it.webui.util.PasswordHelper;
...
public class SystemController{
    ...
    public ResponseVo login(HttpServletRequest request, String username, String password, String verification,
        ...
        //更新最后登录时间
        userService.updateLastLoginTime((SysUser) SecurityUtils.getSubject().getPrincipal());
    ...
    public List<SysPermission> getMenus(){
        List<SysPermission> permissionListList = permissionService.selectMenuByUserId(((SysUser) SecurityUtils.getSubject().getPrincipal()).getUserId());
